...
<div id="page">
  ...
  <?php if ($is_front): ?>
  <?php if (theme_get_setting('slideshow_display','fusionx1')): ?>
  <?php 
    $slide1_head = check_plain(theme_get_setting('slide1_head','fusionx1'));   $slide1_desc = check_markup(theme_get_setting('slide1_desc','fusionx1'), 'full_html'); $slide1_url = check_plain(theme_get_setting('slide1_url','fusionx1'));
    $slide2_head = check_plain(theme_get_setting('slide2_head','fusionx1'));   $slide2_desc = check_markup(theme_get_setting('slide2_desc','fusionx1'), 'full_html'); $slide2_url = check_plain(theme_get_setting('slide2_url','fusionx1'));
    $slide3_head = check_plain(theme_get_setting('slide3_head','fusionx1'));   $slide3_desc = check_markup(theme_get_setting('slide3_desc','fusionx1'), 'full_html'); $slide3_url = check_plain(theme_get_setting('slide3_url','fusionx1'));
  ?>
  <div id="slidebox" class="flexslider">
    <ul class="slides">
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'fusionx1') . '/images/pic1.jpg'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'fusionx1') . '/images/pic2.jpg'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'fusionx1') . '/images/pic3.jpg'; ?>"/>
    ...
    <div class="container">
      <div class="row">
        <div class="fcred col-sm-12">
          <?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <a href="<?php print $front_page; ?>"><?php print $site_name; ?></a>. <?php print t('Theme by'); ?>  <a href="http://codecrafts.ph" target="_blank">Fusionx1</a>.
        </div>
      </div>
    </div>
  </div>
